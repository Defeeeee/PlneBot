...
client.on("ready", () => {
    ...
    client.user.setActivity({ type: "PLAYING", name: `cat vibin` })
})
...
client.on("message", async message => {
    ...
    if (!cmd) return
    if (cmd.inVoiceChannel && !message.member.voice.channel) return message.channel.send(`${client.emotes.error} | Tenes que estar en un canal de voz!`)
    try {
